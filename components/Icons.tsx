...
// Using simple SVG icons to avoid external dependency issues in code generation context, 
// ensuring "World Class" reliability without npm install errors.
...
export const IconMove = ({ className }: { className?: string }) => (
